...
export const initialServices: Service[] = [
  // 1. Módulo "Nómina y Pagos"
  {
    ...
    tags: ['pago', 'sueldo', 'salario', 'fechas', 'calendario', 'depósito', 'semanal', 'quincenal', 'dispersión'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  },
  {
    ...
    category: 'Nómina y Pagos',
    tags: ['recibos', 'nómina', 'timbrado', 'cif', 'sat', 'comprobante', 'constancia', 'fiscal', 'xml', 'pdf', 'descarga'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  },
  {
    ...
    category: 'Nómina y Pagos',
    tags: ['aclaración', 'dudas', 'pago', 'descuentos', 'retenciones', 'fonacot', 'recursos humanos', 'rh', 'sueldo'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  // 2. Módulo "Tarjetas y Créditos"
  {
    ...
    tags: ['vales', 'despensa', 'tarjeta', 'plástico', 'reposición', 'nip', 'saldo', 'compras', 'robo', 'extravío'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  },
  {
    ...
    category: 'Tarjetas y Créditos',
    tags: ['préstamos', 'ahorro', 'caja de ahorro', 'fondo', 'intereses', 'financiamiento', 'solicitud', 'crédito'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  },
  {
    ...
    category: 'Tarjetas y Créditos',
    tags: ['infonavit', 'crédito', 'vivienda', 'retención', 'aviso', 'descuento', 'casa', 'hipotecario', 'constancia'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  // 3. Módulo "Control y Asistencia"
  {
    ...
    tags: ['vacaciones', 'días disponibles', 'descanso', 'home week', 'días flex', 'prima vacacional', 'solicitud', 'permiso'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
  ...
  },
  {
    ...
    category: 'Control y Asistencia',
    tags: ['incapacidad', 'imss', 'médico', 'enfermedad', 'accidente', 'maternidad', 'riesgo de trabajo', 'st-7', 'subsidio', 'constancia'],
  ...
  },
  {
    ...
    category: 'Control y Asistencia',
    tags: ['checador', 'asistencia', 'reloj', 'lector', 'huella', 'gafete', 'retardo', 'omisión', 'incidencia', 'marcas', 'horario'],
    fullDescription: '',
    steps: [],
    requirements: [],
    faqs: [],
